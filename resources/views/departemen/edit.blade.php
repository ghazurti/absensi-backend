...
@section('breadcrumb')Manajemen / <a href="{{ route('departemen.index') }}" style="color:inherit">Departemen</a> / <span>Edit</span>@endsection

@section('content')
<div style="font-size:22px;font-weight:800;color:var(--gray-900);margin-bottom:24px">Edit Departemen</div>

<div style="max-width:680px">
    <div class="card">
        <div class="card-header">
            <span><i class="bi bi-pencil-square me-2" style="color:var(--primary)"></i>Ubah Data Departemen</span>
        </div>
        <div class="card-body">
            <form action="{{ route('departemen.update', $departemen) }}" method="POST">
                ...
                <div style="display:grid;grid-template-columns:120px 1fr;gap:20px">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" value="{{ old('nama', $departemen->nama) }}"
                ...
                <div class="form-group">
                    ...
                    <textarea name="keterangan" class="form-control" rows="4" 
                        placeholder="Deskripsi singkat mengenai departemen ini (opsional)">{{ old('keterangan', $departemen->keterangan) }}</textarea>
                    @error('keterangan')<div style="color:#dc2626;font-size:12px;margin-top:4px">{{ $message }}</div>@enderror
                </div>

                <div style="display:flex;gap:10px;margin-top:16px">
                    <button type="submit" class="btn btn-primary" style="padding:10px 24px">
                        <i class="bi bi-save"></i> Perbarui Departemen
                    </button>
